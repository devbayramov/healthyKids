  ...
  const tests: TestOption[] = [
    {
      ...
      icon: "flash",
      route: "/tests/game-detail/reaction",
    },
    {
      id: "2",
      title: "Yaddaş Oyunu",
      icon: "brain",
      route: "/tests/game-detail/memory",
    },
    {
      id: "3",
      title: "Tapmacalar",
      icon: "puzzle",
      route: "/tests/game-detail/puzzles",
    },
    {
      id: "4",
      title: "Sürət Testi",
      icon: "speedometer",
      route: "/tests/game-detail/speed",
    },
  ];
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Oyun Testləri</Text>
        <View style={{ width: 28 }} />
      </View>
