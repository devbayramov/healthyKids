  ...
  const tests: TestOption[] = [
    {
      ...
      route: "/tests/personality-detail/type",
    },
    {
      id: "2",
      title: "Xarakter Xüsusiyyətləri",
      icon: "account-star",
      route: "/tests/personality-detail/traits",
    },
    {
      id: "3",
      title: "Sosial Davranış",
      icon: "account-group",
      route: "/tests/personality-detail/social",
    },
    {
      id: "4",
      title: "Özünü Tanıma",
      icon: "account-heart",
      route: "/tests/personality-detail/self",
    },
  ];
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Şəxsiyyət Testləri</Text>
        <View style={{ width: 28 }} />
      </View>
